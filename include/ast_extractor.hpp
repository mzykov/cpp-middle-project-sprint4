...
class ASTExtractor {
public:
    std::optional<std::pair<std::string, size_t>> ExtractClassDefenitionASTFragment(const std::string &ast,
                                                                                    size_t start_parsing_at = 0) const;
    ...
    std::optional<std::pair<std::string, size_t>> ExtractIdentifierASTFragment(const std::string &ast,
                                                                               size_t start_parsing_at = 0) const;

    std::optional<std::pair<std::string, size_t>> ExtractParametersASTFragment(const std::string &ast,
                                                                               size_t start_parsing_at = 0) const;

    std::optional<std::pair<std::string, size_t>> ExtractCommentASTFragment(const std::string &ast,
                                                                            size_t start_parsing_at = 0) const;
